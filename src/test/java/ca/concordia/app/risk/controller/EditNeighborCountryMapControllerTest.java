...
public class EditNeighborCountryMapControllerTest {
	...
	/**
	 * add neighbor country(borders) should return number of countries if all the
	 * countries are connected by neighbors
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editneighbor(String,
	...
	/**
	 * add neighbor country(edge)-all countries are in the same continent should
	 * return number of countries if all the countries are connected by neighbors
	...
	/**
	 * add neighbor country(edge)-countries are in different continents should
	 * return number of countries if all the countries are connected by neighbors
	 * should return number of edges in graph * 2, since graph is bidirectional
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editneighbor(String,
	...
	/**
	 * add and remove operations on neighbor countries(borders) should return number
	 * of edges in graph * 2, since graph is bidirectional
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editneighbor(String,
	 *      String, String, String)
	 */
	...
	/**
	 * remove operation on neighbor countries(borders) should return number of edges
	 * in graph * 2, since graph is bidirectional
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editneighbor(String,
	 *      String, String, String)
	 */
