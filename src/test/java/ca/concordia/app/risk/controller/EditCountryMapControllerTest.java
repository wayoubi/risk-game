...
public class EditCountryMapControllerTest {
	...
	/**
	 * add country should return number of countries if countries added properly
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcountry(String,
	 *      String, String)
	 */
	@Test
	...
	/**
	 * duplicate country entries in the same continent should return non-duplicated
	 * count if a country added 2 times in the same continent
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcountry(String,
	 *      String, String)
	 */
	...
	/**
	 * duplicate country entries in the whole map(different continents) should
	 * return non-duplicated count if a country added 2 times in the map
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcountry(String,
	 *      String, String)
	 */
	...
	/**
	 * remove operation on a country should return null after remove
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcountry(String,
	 *      String, String)
	 */
	...
	/**
	 * add and remove operations on a country should return not null after add
	...
	/**
	 * remove country that doesn't exist should return not null for existing
	 * countries after removing a country that doesn't exist
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcountry(String,
	 *      String, String)
	 */
