...
public class PlayerControllerTest {
	...
	/**
	 * add player should return number of players even in case of edit a player's
	 * name
	 * 
	 * @see ca.concordia.app.risk.controller.GameController#gameplayer(String,
	 *      String)
	 */
	@Test
	...
	/**
	 * duplicate player entries should return non-duplicated count of players if a
	 * player added 2 times
	 * 
	 * @see ca.concordia.app.risk.controller.GameController#gameplayer(String,
	 *      String)
	 */
	...
	/**
	 * color of the player should return color of the related player
	 * 
	 * @see ca.concordia.app.risk.controller.GameController#gameplayer(String,
	 *      String)
	 */
	...
	/**
	 * populate countries among player should return number of countries per player
	 * 
	...
	public void testPopulateCountries() {
		...
		assertEquals(3, RunningGame.getInstance().getCountries().getList().stream().filter(c -> c.getPlayerId() == 1)
				.collect(Collectors.toList()).size());
		assertEquals(2, RunningGame.getInstance().getCountries().getList().stream().filter(c -> c.getPlayerId() == 2)
				.collect(Collectors.toList()).size());
	}

	/**
	 * place army for non-active player should return 0 as a number of armies placed
	...
	public void testPlaceArmyNotActivePlayerTurn() {
		...
		List<CountryModel> countryModel = RunningGame.getInstance().getCountries().getList().stream()
				.filter(c -> "India".equalsIgnoreCase(c.getName())).collect(Collectors.toList());
		int actual = countryModel.get(0).getNumberOfArmies();
		assertEquals(0, actual);
	}

	/**
	 * place army for active player should return 1 as a number of armies placed for
	 * an active player
	 * 
	 * @see ca.concordia.app.risk.controller.GameController#placearmy(String)
	 */
	...
	public void testPlaceArmyActivePlayerTurn() {
		...
		List<CountryModel> countryModel = RunningGame.getInstance().getCountries().getList().stream()
				.filter(c -> "Jordan".equalsIgnoreCase(c.getName())).collect(Collectors.toList());
		int actual = countryModel.get(0).getNumberOfArmies();
		assertEquals(1, actual);
	}

	/**
	 * place army for non-exists country should return 0 as a number of armies
	 * placed for a player
	 * 
	 * @see ca.concordia.app.risk.controller.GameController#placearmy(String)
	 */
	...
	public void testPlaceArmyCountryDoesNotExist() {
		...
		List<CountryModel> countryModel = RunningGame.getInstance().getCountries().getList().stream()
				.filter(c -> "Egypt".equalsIgnoreCase(c.getName())).collect(Collectors.toList());
		assertEquals(0, countryModel.size());
	}

	/**
	 * number of armies after placing army in countries should return corresponding
	 * number
	 * 
	 * @see ca.concordia.app.risk.controller.GameController#placearmy(String)
	 */
	...
	/**
	 * number of armies do not exceed number maximum should return maximum of 40
	 * armies per country
	 * 
	 * @see ca.concordia.app.risk.controller.GameController#placearmy(String)
	 */
	...
	/**
	 * placing all armies should return maximum of 40 armies per country
	 * 
	...
	public void testPlaceAll() {
		...
		List<CountryModel> countryModel = RunningGame.getInstance().getCountries().getList().stream()
				.filter(c -> c.getPlayerId() == 1).collect(Collectors.toList());
		assertEquals(40, countryModel.get(0).getNumberOfArmies() + countryModel.get(1).getNumberOfArmies());
	}

	/**
	 * armies reinforcement should return corresponding number of armies
	 * 
