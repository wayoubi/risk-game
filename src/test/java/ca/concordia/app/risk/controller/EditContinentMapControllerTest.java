...
public class EditContinentMapControllerTest {
	...
	/**
	 * add continents should return number of continents if continents added
	 * properly
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcontinent(String,
	 *      String, String)
	 */
	@Test
	...
	/**
	 * duplicate continent entries should return non-duplicated count if a continent
	 * added 2 times
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcontinent(String,
	 *      String, String)
	...
	/**
	 * number of countries in a continent should return not null if continent has at
	 * least 1 country should return null if continent has 0 country
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcontinent(String,
	 *      String, String)
	 */
	 ...
	 * should return maximum number of countries in a continent after adding extra
	 * countries
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcontinent(String,
	 *      String, String)
	...
	/**
	 * add and remove operations on a continent should return not null after add
	...
	/**
	 * remove operation on a continent should return null after remove
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcontinent(String,
	 *      String, String)
	 */
	...
	/**
	 * remove continent that doesn't exist should return not null for existing
	 * continents after removing a continent that doesn't exist
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcontinent(String,
	 *      String, String)
	 */
	...
	/**
	 * continent IDs after adding a continent should return not null for the
	 * continent's corresponding ID
	 * 
	 * @see ca.concordia.app.risk.controller.MapController#editcontinent(String,
	 *      String, String)
	 */
