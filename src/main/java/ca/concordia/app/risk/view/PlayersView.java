...
public class PlayersView extends JPanel implements Observer {
	...
	private final String[] COLUMN_NAMES = { "ID", "Player", "Strategy", "Percentage Controlled", "Continents",
	...
	private void build() {
		...
		for (PlayerModel player : players) {
			...
			for (ContinentModel continent : continents) {
				...
				List<CountryModel> listOfCountriesInContinent = continentDaoImpl.getCountries(RunningGame.getInstance(),
						continent);
				int countryOwns = 0;
