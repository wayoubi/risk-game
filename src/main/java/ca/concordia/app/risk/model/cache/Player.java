...
public class Player extends Observable {
	...
	public void attack(String countryNameFrom, String countyNameTo, String numDice) {
		...
		// "Please complete the Reinforcement - Card Exchange phase first. If you do not
		// have any cards or you don't want to exchange please run, exchangecards
		// -none");
		// }
		...
		if (countryModelFrom.getNumberOfArmies() == 1) {
			throw new RiskGameRuntimeException(
					"Cannot attack from " + countryNameFrom + " since it has only 1 army left");
		}
