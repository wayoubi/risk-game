...
/**
 * <p>
 * Java class for borders complex type.
 *
 * <p>
...
@XmlType(name = "borders", namespace = "http://ca.concordia.app.risk/game", propOrder = {"list"})
public class BordersModel {
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link BorderModel }
     */
