...
public abstract class AbstractStrategy implements Strategy {
	...
	public void defend(String numDice) {
		...
		do {
			...
			if (countryModelAttackFrom.getNumberOfArmies() == 1) {
				...
				System.out.println("Attacker " + this.getPlayerModel().getName() + " has conquered country "
	...
	public void fortify(CountryModel countryModelFrom, CountryModel countryModelTo, int numberOfArmies) {
		...
		if (counter == 0) {
			...
			List<GraphPath<String, DefaultEdge>> allPathsReverse = allDirectedPaths
					.getAllPaths(countryModelTo.getName(), countryModelFrom.getName(), false, 10);
			int counterNew = 0;
	...
	public void reinforce(CountryModel countryModel, int numberOfArmies) {
		if (this.getPlayerModel().getReinforcementNoOfArmies() >= numberOfArmies) {
			...
			System.out.println(
					"You have " + this.getPlayerModel().getReinforcementNoOfArmies() + " armies left to reinforce");
